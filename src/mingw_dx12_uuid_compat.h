...
// (plume, rt64, aerogauge_modern) when compiling with MinGW GCC. Why:
//
...
#define CROSS_PLATFORM_UUIDOF(iface, spec)                                                    \
    ...
    __CRT_UUID_DECL(iface,                                                                    \
        aero_uuid_compat::word_at(spec, 24) | aero_uuid_compat::word_at(spec + 2, 16) |     \
            aero_uuid_compat::word_at(spec + 4, 8) | aero_uuid_compat::word_at(spec + 6, 0),\
        aero_uuid_compat::short_at(spec + 9, 8) | aero_uuid_compat::short_at(spec + 11, 0), \
        aero_uuid_compat::short_at(spec + 14, 8) | aero_uuid_compat::short_at(spec + 16, 0),\
        aero_uuid_compat::byte_at(spec + 19), aero_uuid_compat::byte_at(spec + 21),         \
        aero_uuid_compat::byte_at(spec + 24), aero_uuid_compat::byte_at(spec + 26),         \
        aero_uuid_compat::byte_at(spec + 28), aero_uuid_compat::byte_at(spec + 30),         \
        aero_uuid_compat::byte_at(spec + 32), aero_uuid_compat::byte_at(spec + 34))
#endif
