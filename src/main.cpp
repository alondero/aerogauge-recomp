...
static void input_sample() {
    ...
    if (const Uint8* ks = SDL_GetKeyboardState(nullptr)) {
        ...
        // (F1-F8 developer warp / save-state keys from the Lamborghini port were dropped
        // with those modules; F11 fullscreen stays. Re-grow once AeroGauge's state is mapped.)
    }
