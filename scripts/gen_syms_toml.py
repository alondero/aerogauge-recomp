...
[[patches.hook]]
func = "func_800227E4"
before_vram = 0x800229C8
text = "extern void aero_scene_scissor(uint8_t*, recomp_context*); aero_scene_scissor(rdram, ctx);"

# The optional solid scene background must cover the same expanded area.
[[patches.hook]]
func = "func_800227E4"
before_vram = 0x80022B2C
text = "extern void aero_scene_background(uint8_t*, recomp_context*); aero_scene_background(rdram, ctx);"
...
# request; native in src/aero_savestate.c.
[[patches.hook]]
func = "func_80015C8C"
...
# boundary separates them. The whole dispatcher is bracketed instead: the entry hook
# latches the DL write cursor (holder 0x8016C508); the epilogue hook (before_vram
# 0x80022680, after every child handler has appended, before the register restores)
# post-processes the emitted range --
#   1. re-emits it with RT64 rect-align + wide-scissor brackets around runs of texrects,
#      each rect classified LEFT/RIGHT/centred by its own coordinates (race scene only);
#   2. shifts the speedo needle's G_MTX translate.x (matrix-rotated geometry that a
#      rect-align cannot carry), pinpointed by its G_DL -> static mesh 0x800995C0.
# Scaled/tagged so the whole pass is a no-op at 4:3 / hr_option Original.
[[patches.hook]]
func = "func_80022408"
before_vram = 0x80022408
text = "extern void aero_ws_hud_scan_begin(uint8_t*, recomp_context*); aero_ws_hud_scan_begin(rdram, ctx);"
...
# Intro draw boundaries, disassembled from the USA ROM. Each native updates
# the cursor holder owned by the current function; no timer/state replacement.
[[patches.hook]]
func = "func_8000D708"
before_vram = 0x8000D708
text = "extern void aero_intro_ticker_begin(uint8_t*, recomp_context*); aero_intro_ticker_begin(rdram, ctx);"
[[patches.hook]]
func = "func_8000D708"
before_vram = 0x8000D860
text = "extern void aero_intro_ticker_origin(uint8_t*, recomp_context*); aero_intro_ticker_origin(rdram, ctx);"
[[patches.hook]]
func = "func_8000D708"
before_vram = 0x8000D968
text = "extern void aero_intro_ticker_end(uint8_t*, recomp_context*); aero_intro_ticker_end(rdram, ctx);"
[[patches.hook]]
func = "func_8000D97C"
before_vram = 0x8000DBB0
text = "extern void aero_intro_banner(uint8_t*, recomp_context*); aero_intro_banner(rdram, ctx);"
[[patches.hook]]
func = "func_8001F998"
before_vram = 0x80020174
text = "extern void aero_intro_glyph(uint8_t*, recomp_context*); aero_intro_glyph(rdram, ctx);"
[[patches.hook]]
func = "func_800191FC"
before_vram = 0x800193C4
text = "extern void aero_intro_fade_begin(uint8_t*, recomp_context*); aero_intro_fade_begin(rdram, ctx);"
[[patches.hook]]
func = "func_800191FC"
before_vram = 0x800193CC
text = "extern void aero_intro_fade_end(uint8_t*, recomp_context*); aero_intro_fade_end(rdram, ctx);"
[[patches.hook]]
func = "func_800191FC"
before_vram = 0x800194B8
text = "extern void aero_intro_fade_begin(uint8_t*, recomp_context*); aero_intro_fade_begin(rdram, ctx);"
[[patches.hook]]
func = "func_800191FC"
...
[[patches.hook]]
func = "func_8001AB94"
before_vram = 0x8001AB94
text = "extern void aero_ws_message_begin(uint8_t*, gpr); aero_ws_message_begin(rdram, MEM_W(0, ctx->r4));"

[[patches.hook]]
func = "func_8001AB94"
before_vram = 0x8001AC54
text = "extern void aero_ws_message_end(uint8_t*, gpr); aero_ws_message_end(rdram, MEM_W(0x3C, ctx->r29));"

# WRONG WAY text and arrow sprite.
[[patches.hook]]
func = "func_8001AC64"
before_vram = 0x8001AC64
text = "extern void aero_ws_message_begin(uint8_t*, gpr); aero_ws_message_begin(rdram, MEM_W(0, ctx->r4));"

[[patches.hook]]
func = "func_8001AC64"
before_vram = 0x8001ADB0
text = "extern void aero_ws_message_end(uint8_t*, gpr); aero_ws_message_end(rdram, MEM_W(0x3C, ctx->r29));"

# TIME OVER / GAME OVER / RETIRE / TIME UP.
[[patches.hook]]
func = "func_80019508"
before_vram = 0x80019508
text = "extern void aero_ws_message_begin(uint8_t*, gpr); aero_ws_message_begin(rdram, MEM_W(0, ctx->r4));"

[[patches.hook]]
func = "func_80019508"
before_vram = 0x8001961C
text = "extern void aero_ws_message_end(uint8_t*, gpr); aero_ws_message_end(rdram, MEM_W(0x24, ctx->r29));"

# Only the announcement tails of the mixed timer handler: FINAL LAP / N LAPS
# LEFT, and time-trial lap ordinal + time. All early exits converge at A724.
[[patches.hook]]
func = "func_8001A020"
before_vram = 0x8001A390
text = "extern void aero_ws_message_begin(uint8_t*, gpr); aero_ws_message_begin(rdram, MEM_W(0x94, ctx->r29));"

[[patches.hook]]
func = "func_8001A020"
before_vram = 0x8001A5A0
text = "extern void aero_ws_message_begin(uint8_t*, gpr); aero_ws_message_begin(rdram, MEM_W(0x94, ctx->r29));"

[[patches.hook]]
func = "func_8001A020"
before_vram = 0x8001A724
