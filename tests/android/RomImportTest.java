...
public final class RomImportTest {
    public static void main(String[] args) throws Exception {
        ...
        try {
            for (int order : new int[]{1, 2, 4}) {
                ...
                RomImport.install(new ByteArrayInputStream(converted), temporary.toFile());
            ...
            System.out.println("PASS: all three byte orders; corrupt, short, oversized and interrupted imports preserve the installed ROM.");
        } finally {
    ...
    private static void reject(InputStream input, byte[] expected, Path directory) throws Exception {
        try { RomImport.install(input, directory.toFile()); throw new AssertionError("Accepted invalid import"); }
