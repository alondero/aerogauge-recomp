...
RELEASE_JSON="$(gh api "repos/alondero/aerogauge-recomp/releases/tags/${VERSION}" 2>&1)" || true
...
ASSETS_JSON="$(gh api "repos/alondero/aerogauge-recomp/releases/tags/${VERSION}" \
